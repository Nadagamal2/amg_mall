...
import '../models/privcacy_policy.dart';
...
class _PrivacypolicyScreenState extends State<PrivacypolicyScreen> {
  Future<List<PrivacyPolicy>> getData() async {
    ...
    if (response.statusCode == 200) {
      ...
      List jsonData = (data);
      return jsonData
          .map((categoryData) => PrivacyPolicy.fromJson(categoryData))
          .toList();
    } else {
                ...
                children: [
                  FutureBuilder<List<PrivacyPolicy?>>(
                    ...
                    builder: (context,snapshot){
                      if(snapshot.hasData){
                        List<PrivacyPolicy?>? item = snapshot.data;
                        return Padding(

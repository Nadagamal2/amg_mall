...
class ProductHomeScreen extends StatefulWidget {
  ...
  ProductSubCategHomeModel productModelHome;
  ...
  ProductHomeScreen({
    ...
    required this.productModelHome,
  }) : super(key: key);
  ...
  void AddToCart(
    ...
    try {
      ...
      request.body = json.encode({
        ...
        "productId":  userData.read('add'),
        "applicationUserId": userData.read('token'),
        "quantity":  userData.read('quantity')??1,
      });
                    ...
                    Container(
                      ...
                      child:  MyElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          //     textColor: Colors.white,
                          //     fontSize: 16.0);
                          select==true?AddToCart():Fluttertoast.showToast(
                              msg: 'اختار كمية!',
                              toastLength: Toast.LENGTH_SHORT,
                              gravity: ToastGravity.BOTTOM,
                              timeInSecForIosWeb: 1,
                              textColor: Colors.white,
                              fontSize: 16.0);
                        select==true?  showModalBottomSheet(
                              context: context,
...
List <ProductSubCategHomeModel?> cartList=[];
